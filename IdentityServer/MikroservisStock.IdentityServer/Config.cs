...
namespace MikroservisStock.IdentityServer
{
    public static class Config
    {
        public static IEnumerable<ApiResource> ApiResources => new ApiResource[]
        {
          ...
          new ApiResource("ResourceCatalog2"){Scopes={"CatalogFullPermission"}},
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ...
                AllowedScopes={ "CatalogFullPermission", "OcelotFullPermisson", IdentityServerConstants.LocalApi.ScopeName }
            },
             ...
             new Client
            {
                ...
                ClientSecrets={new Secret("mikroservisstock".Sha256())},
                AllowedScopes={ "CatalogReadPermisson","OcelotFullPermisson", "CatalogFullPermission", "OrderFullPermisson", IdentityServerConstants.LocalApi.ScopeName,
             ...
             new Client
            {
                ...
                AllowedGrantTypes=GrantTypes.ResourceOwnerPassword,
                ClientSecrets={new Secret("mikroservisstock".Sha256())},
                AllowedScopes={ "CatalogReadPermisson", "CatalogFullPermission", "OrderFullPermisson","CargoFullPermisson","OcelotFullPermisson","BasketFullPermisson","PaymentFullPermisson","MessageFullPermisson","DiscountFullPermisson", IdentityServerConstants.LocalApi.ScopeName,
                 IdentityServerConstants.StandardScopes.Email,
                 IdentityServerConstants.StandardScopes.OpenId,
                 IdentityServerConstants.StandardScopes.Profile
                 },
